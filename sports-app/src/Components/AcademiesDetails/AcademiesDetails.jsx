...
function AcademiesDetails() {
  ...
  if (!academy) return <div className="text-center py-20">Academy Not Found</div>;
          ...
          <div className="bg-white shadow-md rounded-2xl p-6 space-y-5 hover:shadow-xl transition">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="shadow-md rounded-xl p-3 flex gap-2 items-center text-sm bg-white hover:shadow-lg transition">
                <FaPhoneAlt className="text-cyan-600" /> {academy.phone}
              </div>
              <div className="shadow-md rounded-xl p-3 flex gap-2 items-center text-sm bg-white hover:shadow-lg transition">
                <FaEnvelope className="text-cyan-600" /> {academy.email}
              </div>
              <div className="shadow-md rounded-xl p-3 flex gap-2 items-center text-sm bg-white hover:shadow-lg transition">
                <FaClock className="text-cyan-600" /> {academy.timing}
              </div>
            </div>

            {/* ADDRESS */}
            <div className="shadow-md rounded-xl p-3 flex gap-2 items-center text-sm bg-white hover:shadow-lg transition">
              <FaMapMarkerAlt className="text-cyan-600" /> {academy.address}
            </div>
...
<div>
  <div className="sticky top-20 bg-white shadow-xl rounded-2xl p-6 space-y-4">
    ...
    <iframe
      ...
      loading="lazy"
      src="https://www.google.com/maps?q=Navrangpura%20Sports%20Complex%20Ahmedabad&output=embed"
      title="Academy Map"
    ></iframe>
    ...
    <button
      onClick={() => {
        if (navigator.share) {
          navigator.share({
            title: "Sardar Patel Sports Academy",
            text: "Check out Sardar Patel Sports Academy on our Sports Portal",
